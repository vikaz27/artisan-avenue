		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a class="active" href="purchase.php">View Status</a><i></i></li>
...
<br>
	...
	<tr>
		  ...
		  <td width="17%"><div align="center" class="style6"><strong> Image</strong> </div></td>
		   ...
		   <td width="13%"><div align="center" class="style6"><strong>Price</strong> </div></td>
			...
			<td width="12%"><div align="center" class="style6"><strong>Amount</strong> </div></td>
			 <td width="13%"><div align="center" class="style6"><strong>Status</strong> </div></td>
        </tr>
		<tr>
		<td colspan="10">&nbsp;</td>
		</tr>
		...
		$id=$row['pid'];
		$sts=$row['status'];
		$qry1=mysql_query("select * from product1 where id='$id'");
