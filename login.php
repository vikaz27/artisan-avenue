<?php
	...
	$row=mysql_num_rows($qry);
		if($row==1)
		{
		$qr=mysql_query("select * from register where uname='$uname'&& psw='$psw'");
...
$max_qry = mysql_query("select max(id) from register");
		...
		$id=$max_row['max(id)']+1;
$qry1=mysql_query("insert into register values('$id','$name','$gender','$email','$phone','$loc','$address','$uname','$psw')");
if($qry1)
{
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a href="admin.php">Admin</a><i></i></li>
					<li><a class="active" href="login.php">Customers</a><i></i></li>
					<li><a href="mail.html">Contact</a></li></li>
