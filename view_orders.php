		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					<li><a href="adminhome.php">Add Product</a><i></i></li>
						<li><a href="pview.php">View Product</a><i></i></li>
					<li><a class="active" href="view_orders.php">View Orders</a><i></i></li>
					<li><a href="viewc.php">View Customer</a><i></i></li>
						...
						<li class="dropdown mega-dropdown active">
							...
							<div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
								<div class="w3ls_vegetables">
									<ul>	
										<li><a href="login.php">Pots</a></li>
										<li><a href="login.php">Sculptures</a></li>
									</ul>
								</div>                  
							</div>				
						</li>
						<li><a href="login.php">Wood Carvings</a></li>
						<li><a href="login.php">Antiques</a></li>
						<li class="dropdown">
...
<br>
   ...
   <h3 class="style12">VIEW ORDERS</h3>
    <p align="center" class="style30">&nbsp;</p>
   <table width="95%" align="center">
	...
	<tr>
		<td colspan="10" align="center">Material  Details</td>
  </tr>
	...
	<tr>
		<td colspan="10">&nbsp;</td>
		  ...
		  <td width="17%"><div align="center" class="style6"><strong> Image</strong> </div></td>
		...
		<?php
		$qry=mysql_query("select * from addcart where status='1' && fid='$fid'");
		$i=1;
		while($row=mysql_fetch_array($qry))
		{
		$pid=$row['pid'];
		$uid=$row['uid'];
		$qry1=mysql_query("select * from product1 where id='$pid'");
        ...
        <tr>
		 <td width="2%">&nbsp;</td>
	      ...
	      <td width="9%"><div align="center"><?php echo $row2['name'];?></div></td>
	      <td width="6%"><div align="center"><?php echo $row2['address'];?></div></td>
	      <td width="8%"><div align="center"><a href="view_orders.php?act=add&oid=<?php echo $row['id'];?>">Delivery</a></div></td>
  </tr>
		...
		$oid=$_REQUEST['oid'];
		$uid=$_REQUEST['uid'];
		$qt=mysql_query("update addcart set status='2' where id='$oid'");
		echo "<script>alert('deliver sucess')</script>";
