		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a class="active" href="viewc.php">View Customer</a><i></i></li>
...
<br>
	...
	<tr>
		<td colspan="10">&nbsp;</td>
		    ...
		    <tr>
          <td width="2%">&nbsp;</td>
          <td width="14%"><div align="center" class="style6"><strong>Customer Name</strong> </div></td>
		   <td width="14%"><div align="center" class="style6"><strong>Gender</strong> </div></td>
