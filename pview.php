...
{
$pid=$_REQUEST['pid'];
$qy=mysql_query("delete from product1 where id='$pid'");
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a class="active" href="pview.php">View Product</a><i></i></li>
	...
	<tr>
		<td colspan="10">&nbsp;</td>
          ...
          <td width="2%">&nbsp;</td>
		    ...
		    <td width="14%"><div align="center" class="style6"><strong>Product Id</strong> </div></td>
		   ...
		   <td width="11%"><div align="center" class="style6"><strong> Quantity</strong> </div></td>
		    <td width="11%"><div align="center" class="style6"><strong>Price</strong> </div></td>
			 <td width="11%"><div align="center" class="style6"><strong>Desc</strong> </div></td>
		   <td width="9%"><div align="center" class="style6"><strong>Status</strong> </div></td>
        </tr>
		<tr>
		<td colspan="10">&nbsp;</td>
		</tr>
		   ...
		   <td><div align="center"><img src="images\<?php echo $row['img'];?>" width="100" height="100"></div></td>
			<td><div align="center"><?php echo $row['id'];?></div></td>
			  ...
			  <td><div align="center"><?php echo $row['desc'];?></div></td>
			   <td><div align="center"><a href="pview.php?act=del&pid=<?php echo $row['id'];?>">Delete product</a></div></td>
